...
import pytest
from models.outgoing_category import OutgoingCategory
...
class TestOutgoingCategory:
    ...
    async def test_delete_category(
        self, access_token_admin, access_token_user, client, create_outgoing_categories
    ):
        """Удаляем категорию"""
        category_id_1 = str(create_outgoing_categories[0].id)
        category_id_2 = str(create_outgoing_categories[1].id)
        category_id_3 = str(create_outgoing_categories[2].id)
    ...
    async def test_update_category(
        ...
        """Обновляем категорию"""
        category = create_outgoing_categories[0]
